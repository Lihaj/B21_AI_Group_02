...
Feature: Admin - Sales API
  ...
  @215521B @API_Sales_Read_001 @TC_API_SALES_12
  ...
  @215521B @API_Sales_Create_002 @TC_API_SALES_15
  ...
  @215521B @API_Sales_Create_003 @TC_API_SALES_16
  ...
  @215521B @API_Sales_Delete_001 @TC_API_SALES_18
  ...
  @215521B @API_Sales_Read_002 @TC_API_SALES_19
  Scenario: Admin gets 404 when sale ID does not exist
    When I send a DELETE request to delete sale with id "999999"
    Then the response status should be 404

  @215521B @API_Sales_Delete_002 @TC_API_SALES_21
  Scenario: Admin receives 500 on internal server error simulation
